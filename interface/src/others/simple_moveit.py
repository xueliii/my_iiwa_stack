...
class simple_moveit(object):
  ...
  def __init__(self):
    ...
    print("============ Get current state: ", state)
    
    names = robot.get_group_names()
    print("============ Get group names: ", names)
    group = robot.get_group('manipulator')
    print("============ Get group: ", type(group))
    ...
    move_group = moveit_commander.MoveGroupCommander(group_name, "iiwa/robot_description")
    print("============ Set up MoveGroupCommander done!")
    ...
    display_trajectory_publisher = rospy.Publisher('/move_group/display_planned_path',
                                                   ...
                                                   queue_size=20)
    print("============ Set up rospy.Publisher done!")
    ...
    self.move_group.set_planner_id(group_name+"[RRTConnectkConfigDefault]")


  def go_to_joint_state(self, joint_list):
